...
from ckanext.harvestodm.model import UPDATE_FREQUENCIES
from ckanext.harvestodm.model import COUNTRIES
from ckanext.harvestodm.model import LANGUAGES
...
def link_for_harvest_object(id=None, guid=None, text=None):
    ...
    if guid:
        ...
        obj = logic.get_action('harvest_object_show')(
            context, {'id': guid, 'attr': 'guid'})
        id = obj.id
